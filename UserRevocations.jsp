...
<div class="main">
  <div class="main_resize">
      ...
      <div class="content_bg">
        <div class="menu_nav">
          <ul>
			...
			<li class="active"><a href="Revocation.jsp">Revocation</a></li>
	...
	<form name="f1" method="post" action="UserRevocation" onsubmit="return validate(this);"><br/>
	
	
			<br/>

<table align="center" width="40" >
			 <tr><td><b>File&nbsp;Name:</b></td><td><select name="t1" multiple>
			 <%
	...
	ResultSet rs = stmt.executeQuery("select share_att from share where owner_name='"+owner+"' and file_name='"+file+"'");
	while(rs.next()){
		String arr[] = rs.getString(1).toString().split("\\s+");
